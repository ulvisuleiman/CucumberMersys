    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 1; i <= 10; i++) { //
            ...
            for (int j = 1; j <= 10; j++) {
                ...
                Cell hucre1 = yeniSatir.createCell(0);
                hucre1.setCellValue(i);
                Cell hucre2 = yeniSatir.createCell(1);
                hucre2.setCellValue("x");
                Cell hucre3 = yeniSatir.createCell(2);
                hucre3.setCellValue(j);
                Cell hucre4 = yeniSatir.createCell(3);
                hucre4.setCellValue("=");
                Cell hucre5 = yeniSatir.createCell(4);
        ...
        //ctrl+s
        String path = "src/test/java/ApachePOI/resources/NewExcel1.xlsx";
